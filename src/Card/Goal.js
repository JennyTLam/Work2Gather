...
const Goal = ({ goal, user }) => {
  ...
  const [circle1Ref] = useState(React.createRef());
  const [circle2Ref] = useState(React.createRef());
  ...
  const [goalCircleRef] = useState(React.createRef());
  ...
  const [fullCardRef] = useState(React.createRef());
